...
export const App: React.FC = () => {
  ...
  if (showLanding) return <LandingPage onStart={() => setShowLanding(false)} onOpenAiStudio={() => { setShowLanding(false); setIsStudioOpen(true); }} onLoadProject={handleLoadProject} />;
